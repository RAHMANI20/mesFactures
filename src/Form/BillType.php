...
class BillType extends AbstractType
{
    ...
    public function __construct(PreferenceBillRepository $preferenceBillRepository,PreferenceGeneralRepository $preferenceGeneralRepository){
        $this->text_introduction = $preferenceBillRepository->find(1)->getTextIntroduction();
        $this->text_conclusion = $preferenceBillRepository->find(1)->getTextConclusion();
        $this->pied_page = $preferenceBillRepository->find(1)->getPiedPage();
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('text_introduction',TextareaType::class,[
                ...
                'label' => 'Texte d\'introduction (visible sur la facture)'
            ])
            ->add('text_conclusion',TextareaType::class,[
                ...
                'label' => 'Texte de conclusion (visible sur la facture)'
            ])
            ->add('pied_page',TextareaType::class,[
                ...
                'data' => $this->pied_page,
                'label' => 'Pied de page (visible sur la facture)'
            ])
